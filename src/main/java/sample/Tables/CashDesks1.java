...
public class CashDesks1 implements Serializable
{
    ...
    public int getSaleId(int id) {return saleid;} public void setSaleId(int saleid) {this.saleid=saleid;}
    public double getSMoney() {return smoney;} public void setSmoney(double smoney) {this.smoney=smoney;}
